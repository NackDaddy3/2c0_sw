...
int main(void)
{
    ...
    //AG: This doesn't specify primary or secondary because they might be on the same address so it is able to send both to them.
    //AG: wait a
...
//AG: edited
    ...
    //      .okId     = GPIO_ID_OK,
    //      .dmux1Id  = GPIO_ID_DMUX1_A,
    //      .dmux2Id  = GPIO_ID_DMUX2_A,
    //      .dmux3Id  = GPIO_ID_DMUX3_A},
    //     {.spiRftId = GPIO_ID_RFT_B,  // Secondary device RFT pin
    //      .okId     = GPIO_ID_OK,
    //      .dmux1Id  = GPIO_ID_DMUX1_B,
    //      .dmux2Id  = GPIO_ID_DMUX2_B,
    //      .dmux3Id  = GPIO_ID_DMUX3_B},
    // };
