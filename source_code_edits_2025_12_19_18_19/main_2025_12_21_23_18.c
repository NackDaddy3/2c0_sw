...
static char g_config[32] = "CFG_A";  // for later; keep placeholder now
...
//AG: CGT
ui_write_radar_status("INACTIVE", 0.0, 0, 0, "CFG_A",payload.cycle_count,payload.cycle_max);
...
// printf("\rGMSL payload of %.5f          " , fgigapayload);
...
//AG: Update UI
ui_write_radar_status("ACTIVE", fgigapayload, (int)payload.fps, (int)payload.num_ramps, "CFG_A",payload.cycle_count,payload.cycle_max);
