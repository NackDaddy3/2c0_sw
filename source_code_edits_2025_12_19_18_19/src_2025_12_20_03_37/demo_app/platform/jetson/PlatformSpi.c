 ...
 * ---------------
 * Last Modified: Wednesday, 05 February 2025, 14:40
...
int PlatformSpi_configure(uint8_t spiId, uint8_t flags, uint32_t speed)
{
    ...
    switch (flags)
    {
        case IFXRFE_SPI_MODE_0:
            spi_mode = SPI_MODE_0;
            break;
        case IFXRFE_SPI_MODE_1:
            spi_mode = SPI_MODE_1;
            break;
        case IFXRFE_SPI_MODE_2:
            spi_mode = SPI_MODE_2;
            break;
        case IFXRFE_SPI_MODE_3:
            spi_mode = SPI_MODE_3;
            break;
        default:
            if (!alreadyConfigured)
