...
#define ERROR_CHECK_FLAG_CRI        (0b00000010)
#define ERROR_CHECK_FLAG_OPCODE     (0b00000100)
#define ERROR_CHECK_FLAG_PAYLOAD    (0b00001000)
#define ERROR_CHECK_FLAG_COMMAND_ID (0b00010000)

#define ENABLE_ALL_ERROR_CHECKS  (ERROR_CHECK_FLAG_SIZE | ERROR_CHECK_FLAG_CRI | ERROR_CHECK_FLAG_OPCODE | ERROR_CHECK_FLAG_PAYLOAD | ERROR_CHECK_FLAG_COMMAND_ID)
