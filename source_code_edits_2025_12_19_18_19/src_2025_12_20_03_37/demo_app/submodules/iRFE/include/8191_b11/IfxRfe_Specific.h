...
#ifndef IFXRFE_SPECIFIC_H_8191_B11
#define IFXRFE_SPECIFIC_H_8191_B11 1
...
/******************************************************************************/
#ifdef __cplusplus
#include INCLUDE_JOIN(FIRMWARE_PATH_8191_B11, ram_fw.h)
#else
#include <ram_fw.h>
#endif
...
namespace IfxRfe_Ctrx8191_B11
{
    ...
    typedef struct
    {
        uint8_t clockOutputEnable;                             // CTRX clock output enable/disable. 0: Disabled
    ...
    /// \param clockOutputEnable CTRX clock output enable/disable. 0: Disabled
...
#endif /* IFXRFE_SPECIFIC_H_8191_B11 */
