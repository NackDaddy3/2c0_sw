...
extern "C"
{
    ...
    /// \brief Enable or disable the crc check in the spi routines
    /// \param enabled true to enable, false to disable
    /// \details The A-step does not have crc calculation in the ROM-FW, therefore the CRC16 and CRC32 fields are empty in
    ///          the responses as long as the RAM-FW is not downloaded
